...
TTProfileLoader::TTProfileLoader () : FoldableToolPanel(this,"TTProfileLoader",M("TP_THEMETOOL_LABEL"),false,false)
{
	...
	pack_start( *themeBox1, Gtk::PACK_SHRINK, 0);
        ...
        lbAutoloadSettings = Gtk::manage(new Gtk::Label(M("TT_PROFILE_LOADER_AUTOLOAD_SETTINGS")));
       ...
       buttonSave->signal_button_release_event().connect_notify( sigc::mem_fun(*this, &TTProfileLoader::save_clicked) );
       cbAutoloadSettings->signal_button_release_event().connect_notify( sigc::mem_fun(*this, &TTProfileLoader::autoload_clicked) );
       profilbox->signal_changed ().connect (sigc::mem_fun (*this, &TTProfileLoader::profileBoxChanged));

}

void TTProfileLoader::deploy()
{
...
void TTProfileLoader::profileBoxChanged()
{
...
void TTProfileLoader::parseProfileFolder()
{
...
void TTProfileLoader::resetFavoriteAndTrashState() 
{
/*
...
void TTProfileLoader::load_profile(Glib::ustring filename)
{

   printf("changing to %s \n", filename.c_str());
  env->getProfilePanel()->setProfilePanel(filename);
...
void TTProfileLoader::save_profile(Glib::ustring filename)
{
/*
  Glib::ustring lines = "";
...
void TTProfileLoader::autoload_clicked (GdkEventButton* event)
{
  /*
  if (event->button != 1) {
        return;
...
void TTProfileLoader::save_clicked (GdkEventButton* event)
{
/*
    if (event->button != 1) {
        return;
...
Glib::ustring TTProfileLoader::themeExport()
{
/*
...
void TTProfileLoader::themeImport(std::ifstream& myfile)
{
/*
