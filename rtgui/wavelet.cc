...
Wavelet::Wavelet() :
 ...
 //   threshold2(Gtk::manage(new Adjuster(M("TP_WAVELET_THRESHOLD2"), 1, 9, 1, 4))),
    ...
    expchroma(Gtk::manage(new MyExpander(true, M("TP_WAVELET_LEVCH"),this))),
    expcontrast(Gtk::manage(new MyExpander(true, M("TP_WAVELET_LEVF"),this))),
    expedge(Gtk::manage(new MyExpander(true, M("TP_WAVELET_EDGE"),this))),
    expfinal(Gtk::manage(new MyExpander(true, M("TP_WAVELET_FINAL"),this))),
    expgamut(Gtk::manage(new MyExpander(false, M("TP_WAVELET_CONTR"),this))),
    expnoise(Gtk::manage(new MyExpander(true, M("TP_WAVELET_NOISE"),this))),
    expresid(Gtk::manage(new MyExpander(true, M("TP_WAVELET_RESID"),this))),
